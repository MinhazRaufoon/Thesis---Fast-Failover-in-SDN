...
#####ENABLE STP########
print "enabling spanning tree protocol..."
for switch in switches:
	switch.cmd( 'ovs-vsctl set-fail-mode', switch , 'standalone' ) #LEARNS MAC
	switch.cmd('ovs-vsctl set Bridge', switch , 'stp_enable=true') #STP
...
t1 = time()
print "spanning tree protocol has been enabled (time taken= %ss)..."%(t1-t0)
